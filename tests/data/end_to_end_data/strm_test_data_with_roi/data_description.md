...
* **input** folder containing:
  ...
  * *test_config.json* : input configuration file to run demcompare on the input dems with *nuth_kaab_internal*, the default *sampling_source* (*dem_to_align*), **and an input Region of Interest for the dem to align**.
