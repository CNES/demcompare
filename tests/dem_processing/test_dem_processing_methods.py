...
def test_alti_diff_norm():
    ...
    diff_gt = np.array(
        [
            [-2.1507046, 1.87766, -2.15885, -3.1442332, -2.156697, -0.13951078],
            [2.880849, 3.8992403, 1.8766495, -1.1405015, 0.8689148, 4.88624],
            [
                -3.6303244,
                -0.16096859,
                2.094495,
            ...
            [12.94008, 20.11382, 16.70385, -4.6850934, -2.1418908, -1.1402158],
        ],
        dtype=np.float32,
    )
